 ...
 */
final class Version20241215082806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_c5d30d0349ca1b72');
        $this->addSql('ALTER TABLE loan DROP loaned_by_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE loan ADD loaned_by_id INT NOT NULL');
